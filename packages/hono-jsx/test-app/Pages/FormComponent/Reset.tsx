  ...
  return (
    <Form action="/dump/post" method="post" ref={formRef}>
      ...
      <div>
        ...
        <label>
          <input type="radio" name="plan" id="plan_pro" value="pro" checked /> Pro
        </label>
        <label>
      ...
      <div>
        <label>
          <input type="radio" name="priority" id="priority_low" value="low" checked /> Low
        </label>
        <label>
      ...
      <div>
        <label>
          <input type="checkbox" name="interests[]" id="interests_sports" value="sports" checked /> Sports
        </label>
        <label>
          <input type="checkbox" name="interests[]" id="interests_music" value="music" /> Music
        </label>
        <label>
          <input type="checkbox" name="interests[]" id="interests_tech" value="tech" checked /> Tech
        </label>
        <label>
      ...
      <select name="tools[]" id="tools" multiple>
        <option value="vscode" selected>
          VSCode
        </option>
        <option value="webstorm" selected>
          WebStorm
        </option>
        <option value="sublime" selected>
          Sublime
        </option>
      </select>
      <select name="editor" id="editor">
        <option value="">Select Editor</option>
        <option value="vim" selected>
          Vim
        </option>
      ...
      <textarea name="bio" id="bio" rows={3} value="Default bio text here." />
      <textarea name="notes" id="notes" rows={2} value="" />
      ...
      <div>
        <label>
          <input type="radio" name="rating" id="rating_1" value="1" checked /> 1 Star
        </label>
        <label>
      ...
      <div>
        <label>
          <input type="checkbox" name="years[]" id="years_2020" value="2020" checked /> 2020
        </label>
        <label>
          <input type="checkbox" name="years[]" id="years_2021" value="2021" /> 2021
        </label>
        <label>
          <input type="checkbox" name="years[]" id="years_2022" value="2022" checked /> 2022
        </label>
      </div>
